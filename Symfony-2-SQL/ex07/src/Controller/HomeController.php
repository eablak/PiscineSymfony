...
class HomeController extends AbstractController{
    ...
    #[Route('/e07/create', methods: ['GET','POST'])]
    ...
    #[Route('e07/insert', name:'home', methods: ['GET', 'POST'])]
    ...
    #[Route('e07/delete/{id}', methods: ['GET','POST'])]
    ...
    #[Route('e07/update/{id}', methods: ['GET', 'POST'])]
